  ...
  return (
    <div className="container py-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <Button onClick={() => router.push(`/chat/new?projectId=${project.id}`)}>
      ...
      {chats.length === 0 ? (
        <div className="py-10 text-center bg-muted/40 rounded-lg">
          <p className="text-muted-foreground">No chats in this project yet.</p>
          <Button className="mt-4" onClick={() => router.push(`/chat/new?projectId=${project.id}`)}>
            <MessageSquare className="mr-2 h-4 w-4" />
            ...
            <Card key={chat.id} className="hover:shadow-md transition-shadow">
              <CardHeader className="pb-2">
                ...
                <CardDescription className="text-xs">
                  {chat.createdAt ? format(new Date(chat.createdAt), 'PPP') : 'Unknown'}
                </CardDescription>
              </CardHeader>
