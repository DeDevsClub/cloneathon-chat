  ...
  try {
    ...
    if (!chat) {
      const title = await generateTitleFromUserMessage({
        message: message[0] as UIMessage,
      });
    ...
    const messages = appendClientMessage({
      ...
      message: { ...message[0], createdAt: new Date() },
    });
      ...
      messages: [
        {
          ...
          attachments: messages[0].experimental_attachments ?? [],
          createdAt: new Date(),
          projectId: null,
          contentType: null,
          textContent: null,
            ...
            if (session.user?.id) {
              try {
                ...
                const [, assistantMessage] = appendResponseMessages({
                  messages: [message] as unknown as UIMessage[],
